...
const Comments_for_post = ({
  ...
  const commet_collection =
    collection_name + "blood_camps" + "/" + id + "/" + "comments";
  ...
  const delete_comment = async (get_delete_id) => {
    swal
      .fire({
        ...
        icon: "question",
        text: "You con't undo this comment!",
  ...
  const remove_Replay_Message = async (index, id) => {
    swal
      .fire({
        ...
        showDenyButton: true,
        confirmButtonText: "<h3>Delete</h3>",
            ...
            return (
              <div id="all_comments">
                <div className="message_edit_del_contian">
                  ...
                  {window.sessionStorage.getItem("user_id") === Uploader_id &&
                  window.sessionStorage.getItem("user_id") !==
                    item.comment_poster_id ? (
...
export default Comments_for_post;
